...
namespace sbe {
	...
	class model_container {
		...
		public:
			...
			int get_buf_size()
			{
				return m_batch * m_width * m_height * m_channel;
			}
			...
			model_container(int n, int h, int w, int c, int in, int out, int mdl_id) {
				m_model_id = mdl_id;
                m_batch = n;
				m_width = w;
				m_height = h;
	...
	class mdl_attribute_template {
		public:
			...
			int m_in_cnt;
			int m_out_cnt;
			int m_inbuf_size;   // total size of inbuf
			int m_outbuf_size;  // total size of outbuf
	...
	namespace sbeID2300 {
		class classification : public model_container {
			...
			public :
				classification():model_container(1, 224, 224, 3, 1, 1, IMAGE_CLASSIFICATION) {}
		};
		...
		class classification_offline : public model_container {
			...
			public :
				classification_offline():model_container(4, 224, 224, 3, 1, 1, IMAGE_CLASSIFICATION) {}
		};
		...
		class mobilebert : public model_container {
			...
			public :
				mobilebert():model_container(1, 1, 1, 384, 3, 2, MOBILE_BERT) {}
		};
		...
		class segmentation : public model_container {
			...
			public :
				segmentation():model_container(1, 512, 512, 3, 1, 1, IMAGE_SEGMENTATION) {}
		};
		...
		class detection : public model_container {
			...
			public :
				...
				int det_block_size;
			public :
				detection():model_container(1, 320, 320, 3, 1, 1, OBJECT_DETECTION),
	...
	namespace sbeID2200 {
		...
		class classification_offline : public model_container {
			...
			public :
				classification_offline():model_container(1, 224, 224, 3, 1, 1, IMAGE_CLASSIFICATION) {}
		};
		...
		class mobilebert : public model_container {
			...
			public :
				mobilebert():model_container(1, 384, 384, 3, 3, 2, MOBILE_BERT) {}
		};
	...
	namespace sbeID2100 {
		class detection : public model_container {
			...
			public :
				...
				int det_block_size;
			public :
				detection():model_container(1, 320, 320, 3, 1, 4, OBJECT_DETECTION),
										det_block_cnt(11), det_block_size(7) {}
		};
