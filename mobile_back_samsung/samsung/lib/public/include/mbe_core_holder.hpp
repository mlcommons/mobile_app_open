...
class mbe_core_holder {
 public:
  ...
  using backend_issue_query_t =
      std::add_pointer<intf_mlperf_status_t(ft_callback, void *)>::type;
  ...
  mbe_core_holder()
      : create_fp(nullptr),
        ...
        get_input_count_fp(nullptr),
        get_input_type_fp(nullptr),
        set_input_fp(nullptr),
        get_output_count_fp(nullptr),
        get_output_type_fp(nullptr),
        get_output_fp(nullptr),
