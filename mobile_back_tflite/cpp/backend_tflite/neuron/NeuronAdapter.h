 ...
 * corrupted.
 */
int NeuronModel_restoreFromCompiledNetworkV2(NeuronModel** model,
                                             NeuronCompilation** compilation,
                                             const void* buffer,
                                             const size_t size,
 ...
 * invalid.
 */
int NeuronCompilation_createForDebug(NeuronModel* model,
                                     NeuronCompilation** compilation);
 ...
 * @return NEURON_NO_ERROR if successful.
 */
int NeuronCompilation_setTrimIOAlignment(NeuronCompilation* compilation,
                                         bool enable);
 ...
 * @return NEURON_NO_ERROR if successful
 */
int NeuronCompilation_createForBatch(NeuronModel* model,
                                     NeuronCompilation** compilation);
 ...
 * NeuronCompilation_createForBatch.
 */
int NeuronExecution_setRunnerPoolSize(NeuronExecution* execution,
                                      uint8_t numRunners);
 ...
 * @return NEURON_NO_ERROR if successful
 */
int NeuronCompilation_createForMultiExecutions(NeuronModel* model,
                                               NeuronCompilation** compilation);
 ...
 * @return NEURON_NO_ERROR if successful.
 */
int NeuronDevice_getDescription(const NeuronDevice* device,
 ...
 * @return NEURON_NO_ERROR if successful.
 */
int NeuronCompilation_getPreference(NeuronCompilation* compilation,
                                    int* preference);
 ...
 * @return NEURON_NO_ERROR if successful.
 */
int NeuronCompilation_getPriority(NeuronCompilation* compilation,
                                  int* priority);
