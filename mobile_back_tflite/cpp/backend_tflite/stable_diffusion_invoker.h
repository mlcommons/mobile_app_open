...
private:
    ...
    std::vector<float> encode_unconditional(const std::vector<int> &unconditional_tokens);
    ...
    std::vector<float> get_timestep_embedding(int timestep, int dim = 320, float max_period = 10000.0f);
