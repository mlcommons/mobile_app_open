...
#include "litert_settings_windows.h"
...
// LiteRT is the standard backend for all hardware.
bool mlperf_backend_matches_hardware(const char **not_allowed_message,
                                     const char **settings,
                                     const mlperf_device_info_t *device_info) {
  *not_allowed_message = nullptr;
#if   __APPLE__
  litert_settings_apple = litert_settings_apple_main;
  ...
  switch (modelNumber) {
    case 11:
      // iPhone X series
      litert_settings_apple += litert_settings_apple_iphoneX;
      break;
    case 12:
      // iPhone 11 series
      litert_settings_apple += litert_settings_apple_iphone11;
      break;
    case 13:
      // iPhone 12 series
      litert_settings_apple += litert_settings_apple_iphone12;
      break;
    default:
  ...
  *settings = litert_settings_windows.c_str();
#else
