...
class _ResultListScreenState extends State<ResultListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<ExtendedResult> itemList;
    if (state.resourceManager.resultManager.filteredResults.isEmpty) {
      itemList = state.resourceManager.resultManager.results;
    } else {
      itemList = state.resourceManager.resultManager.filteredResults;
    }
