...
class _BenchmarkExportResultScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(widget.result.benchmarkName)),
  ...
  List<Widget> _makeMainInfo(BenchmarkExportResult res) {
    return [
      ...
      helper.makeInfo(
        l10n.historyRunDetailsScenario,
        res.loadgenScenario.humanName,
      ),
      helper.makeInfo(
        l10n.historyRunDetailsBackendName,
        res.backendInfo.backendName,
      ),
      helper.makeInfo(
        l10n.historyRunDetailsVendorName,
        res.backendInfo.vendorName,
      ),
      helper.makeInfo(
        l10n.historyRunDetailsDelegate,
        res.backendSettings.delegate,
      ),
      helper.makeInfo(
        l10n.historyRunDetailsAccelerator,
        res.backendInfo.acceleratorName,
      ),
      if (res.loadgenScenario == LoadgenScenarioEnum.offline)
        helper.makeInfo(
          l10n.historyRunDetailsBatchSize,
  ...
  List<Widget> _makePerformanceInfo(BenchmarkRunResult perf) {
    return [
      ...
      helper.makeInfo(
        l10n.historyRunDetailsSamples,
        perf.measuredSamples.toString(),
      ),
      helper.makeInfo(
        l10n.historyRunDetailsDatasetType,
        perf.dataset.type.humanName,
      ),
  ...
  List<Widget> _makeAccuracyInfo(BenchmarkRunResult accuracy) {
    return [
      helper.makeInfo(
        l10n.historyRunDetailsAccuracy,
      ...
      helper.makeInfo(
        l10n.historyRunDetailsSamples,
        accuracy.measuredSamples.toString(),
      ),
      helper.makeInfo(
        l10n.historyRunDetailsDatasetType,
        accuracy.dataset.type.humanName,
      ),
