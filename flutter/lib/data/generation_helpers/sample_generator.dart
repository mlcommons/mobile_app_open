...
class SampleGenerator {
  BenchmarkRunResult get runResult => BenchmarkRunResult(
    ...
    accuracy: const Accuracy(normalized: 0.123, formatted: '12.3%'),
    accuracy2: const Accuracy(normalized: 0.123, formatted: '12.3%'),
    dataset: DatasetInfo(
  ...
  EnvironmentInfo get envInfo => EnvironmentInfo(
    ...
    value: EnvInfoValue(
      android: EnvAndroid(
        ...
        procCpuinfoSocName: '',
        props: [
          EnvAndroidProp(type: AndroidPropType.socName, name: '', value: ''),
        ],
      ),
      ios: EnvIos(osVersion: '', modelCode: '', modelName: '', socName: ''),
      windows: EnvWindows(osVersion: '', cpuFullName: ''),
    ),
  );
  ...
  BuildInfo get buildInfo => BuildInfo(
    ...
    gitDirtyFlag: false,
    devTestFlag: true,
    backendList: <String>['libtflitebackend'],
