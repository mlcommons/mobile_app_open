...
void main() async {
  group('CacheManager', () {
    ...
    test('getArchive', () {
      expect(
        manager.getArchive('/foo/bar'),
        isNull,
        reason: 'returned path should be null',
      );
      expect(
        manager.getArchive(txtRemotePath),
        isNull,
        reason: 'returned path should be null',
      );
      expect(
        manager.getArchive(zipRemotePath),
        isNotNull,
    ...
    test('isResourceAnArchive', () {
      expect(
        manager.isResourceAnArchive(txtRemotePath),
        isFalse,
        reason: 'resource should not be an archive',
      );
      expect(
        manager.isResourceAnArchive(zipRemotePath),
        isTrue,
    ...
    test('deleteArchives', () async {
      ...
      expect(
        await File(zipLocalPath!).exists(),
        isFalse,
    ...
    test('deleteFiles', () async {
      ...
      expect(
        await File(txtLocalPath!).exists(),
        isFalse,
    ...
    test('deleteLoadedResources', () async {
      ...
      expect(
        await File(zipLocalFilePath!).exists(),
        isFalse,
