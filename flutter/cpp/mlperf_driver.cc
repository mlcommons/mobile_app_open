...
void MlperfDriver::RunMLPerfTest(const std::string& mode, int min_query_count,
  ...
  mlperf_settings.qsl_rng_seed = 14284205019438841327UL;
  mlperf_settings.sample_index_rng_seed = 4163916728725999944UL;
  mlperf_settings.schedule_rng_seed = 299063814864929621UL;
