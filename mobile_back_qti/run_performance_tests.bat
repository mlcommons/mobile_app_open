...
.\main.exe EXTERNAL imagenet --mode=PerformanceOnly --images_directory=%dataset_path%\imagenet\img --offset=1 --output_dir=%test_case%%test_case_suffix% --min_query_count=%min_query% --min_duration=%min_duration% --single_stream_expected_latency_ns=1000000 --groundtruth_file=%dataset_path% --model_file=%models_path%\mobilenet_edgetpu_224_1.0_htp.dlc --lib_path=libqtibackend.dll --native_lib_path=. --results_file=%results_prefix%%test_case%%results_suffix%
...
mkdir %test_case%%test_case_suffix%
.\main.exe EXTERNAL ade20k --mode=PerformanceOnly --images_directory=%dataset_path%\ade20k\images --num_class=31 --output_dir=%test_case%%test_case_suffix% --min_query_count=%min_query% --min_duration=%min_duration% --single_stream_expected_latency_ns=1000000 --ground_truth_directory= --model_file=%models_path%\mobile_mosaic_htp.dlc --lib_path=libqtibackend.dll --native_lib_path=. --results_file=%results_prefix%%test_case%%results_suffix%
timeout /t %cooldown_period% /nobreak
type %results_prefix%%test_case%%results_suffix% >> %results_file%

set test_case=language_understanding
mkdir %test_case%%test_case_suffix%
.\main.exe EXTERNAL squad --mode=PerformanceOnly --input_file=%dataset_path%\squad\squad_eval_mini.tfrecord --output_dir=%test_case%%test_case_suffix% --min_query_count=%min_query% --min_duration=%min_duration% --single_stream_expected_latency_ns=1000000 --groundtruth_file= --model_file=%models_path%\mobilebert_quantized_htp.dlc --lib_path=libqtibackend.dll --native_lib_path=. --results_file=%results_prefix%%test_case%%results_suffix%
timeout /t %cooldown_period% /nobreak
type %results_prefix%%test_case%%results_suffix% >> %results_file%

set test_case=super_resolution
mkdir %test_case%%test_case_suffix%
.\main.exe EXTERNAL SNUSR --mode=PerformanceOnly --images_directory=%dataset_path%\super_resolution\lr --output_dir=%test_case%%test_case_suffix% --min_query_count=%min_query% --min_duration=%min_duration% --single_stream_expected_latency_ns=1000000 --ground_truth_directory=. --model_file=%models_path%\snusr_htp.dlc --lib_path=libqtibackend.dll --native_lib_path=. --results_file=%results_prefix%%test_case%%results_suffix%
timeout /t %cooldown_period% /nobreak
type %results_prefix%%test_case%%results_suffix% >> %results_file%

set test_case=image_classification_offline
mkdir %test_case%%test_case_suffix%
.\main.exe EXTERNAL imagenet --mode=PerformanceOnly --scenario=Offline --batch_size=12288 --images_directory=%dataset_path%\imagenet\img --offset=1 --output_dir=%test_case%%test_case_suffix% --min_query_count=24576 --min_duration=0 --single_stream_expected_latency_ns=1000000 --groundtruth_file=%dataset_path% --model_file=%models_path%\mobilenet_edgetpu_224_1.0_htp_batched_sd8pg1.dlc --lib_path=libqtibackend.dll --native_lib_path=. --results_file=%results_prefix%%test_case%%results_suffix%
type %results_prefix%%test_case%%results_suffix% >> %results_file%
